...
Dtop = %A_Desktop%
FileReadLine, userName3, C:\Users\mat.hough\Desktop\logInfo.txt, 1
FileReadLine, userName, %Dtop%\logInfo.txt, 1
FileReadLine, userPassword, A_Desktop\logInfo.txt, 2
FileReadLine, BPCSPassword, %A_Desktop%\logInfo.txt, 3
FileReadLine, userName, %Dtop%\logInfo.txt, 1
userName2 = %userName%
blerb
msgbox, %userName2% %userName% space enter %userPassword% usnm3 %userName3% 
