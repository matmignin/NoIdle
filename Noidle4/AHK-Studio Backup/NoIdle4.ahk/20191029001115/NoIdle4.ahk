...
HelpBox = 
( 	
____________ View Process Sample Tab of LIMS `n
...
____________ Create Batch Tab of LIMS  `n`n doesnt always work the first time`n 
-Press [ NumPad( * ) ]  to create Bulk Liquid batch `n 
-Press [ NumPad( - ) ] to create a Raw Material  `n`n 
____________ My Service Group Pending Test tab of LIMS `n 
