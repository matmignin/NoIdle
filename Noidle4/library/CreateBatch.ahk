CreateBatch() {
	...
	ControlGet, SampleGroupType, List,, %ControlSampleGroupBox%
	control, ChooseString, %SampleGroupSelection%, %ControlSampleGroupTemplateBox%
	sleep 400
	
	sleep 600
	Click, %ClickSampleGroupTemplate%
	sleep 500
	ControlGet, MatCodeList, List,, %ControlSampleGroupTemplateBox%
	control, ChooseString, %itemNumber%, %ControlSampleGroupTemplateBox%
