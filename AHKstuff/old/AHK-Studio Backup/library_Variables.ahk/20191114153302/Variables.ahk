...
AdjustB = L, 96, 342, 2
BatchTemplateLink = WindowsForms10.STATIC.app.0.33c0d9d4, ahk_class WindowsForms10.Window.8.app.0.33c0d9d, Select Login Method
...
SampleGroupTemplateBox = WindowsForms10.COMBOBOX.app.0.33c0d9d2 , ahk_class WindowsForms10.Window.8.app.0.33c0d9d, Lot template login
SampleGroupBox = WindowsForms10.COMBOBOX.app.0.33c0d9d1, ahk_class WindowsForms10.Window.8.app.0.33c0d9d, Lot template login
ClickSampleGroupTemplate = 700, 86 Left, 1
ClickSampleGroupBox = 200, 86 Left, 1
ClickBatchTemplateLink = 343, 44, Left, 1
Adobe = AcroRd32.exe
Excel = EXCEL.EXE
Window = WINWORD.EXE
